    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">[DELULUUU]</span> 🎂
              </>
            ) : (
              <>
          ...
          <p>u mean more to me than wordssss can never explainnn 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — [SOLULUU] 💖</h2>
          <p className="final-subtitle">ik shabaa ye besttt nhii hhh pr har chhotii chhotii cheezo me ek hi intention hh just to see u smilingg hope tumhe accha lgee ✨</p>
        </section>
      </div>
